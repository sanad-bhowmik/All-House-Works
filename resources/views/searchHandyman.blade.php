...
<head>
    ...
    <title>AllHouseWorks | Handyman</title>
...
<!-- Header -->
    ...
    <!-- Navigation Menu -->
    <section class="parallax" style="position: relative; background: url('https://www.emoversqatar.com/wp-content/uploads/quiet-expert-img.jpg') no-repeat center center fixed; background-size: cover; height: 18.75rem;">
