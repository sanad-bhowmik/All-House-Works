...
<head>
    ...
    <title>AllHouseWorks | Floor CLean</title>
...
<body class="bg-white relative">
    ...
    <!-- Header -->
    <section class="parallax" style="position: relative; background: url('https://www.thespruce.com/thmb/KWW1WcB1_YIiidBEcL6fh7NgCr4=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/spr-floor-cleaners-test-bona-hardwood-dburreson-004-241-5d0d7242eec6492a894a831916af39ad.jpeg') no-repeat center center fixed; background-size: cover; height: 300px;">
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://chetscleaning.com/wp-content/uploads/Before-and-after-pics-templates-5.png" class="w-full align-middle rounded-t-lg">
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Floor Clean Services for Modern Living Convenience</span>
            </h3>
            <style>
    ...
    <!-- component -->
    <section class="mb-20" style="background-image: linear-gradient(rgb(0,0,0,0.7), rgb(0,0,0,0.7)),url(&quot;https://muhammadyunus.org/includes/themes/best/yc/img/cool-background.jpg&quot;);background-attachment: fixed;">
            ...
            <div class="w-full px-4">
                <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
                    <h2 class=" font-bold  text-3xl sm:text-4xl md:text-[40px] text-dark mb-4 ">
                        OUR COMPLETED FLOOR CLEAN WORKS
                    </h2>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 h-full">
                <div class="col-span-2 sm:col-span-1 md:col-span-2 bg-gray-50 h-auto md:h-full flex flex-col">
                    <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 flex-grow">
                        <img src="https://res.cloudinary.com/liaison-inc/image/upload/c_fill,f_auto,q_auto/services/homeguide/backgrounds/floor-cleaning.jpg" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                        <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                    </a>
                </div>
                <div class="col-span-2 sm:col-span-1 md:col-span-2 bg-stone-50">
                    <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 mb-4">
                        <img src="https://idealserviceuae.com/resource/frontend/images/floor4.jpg" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                        <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                    </a>
                    <div class="grid gap-4 grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
                        <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40">
                            <img src="https://5.imimg.com/data5/SELLER/Default/2022/11/AV/YZ/YD/162243507/deep-house-cleaning-services-500x500.jpg" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                            <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                        </a>
                        <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40">
                            <img src="https://3.imimg.com/data3/TA/FU/MY-9003488/how-much-does-office-cleaning-service-cost2-500x500.jpg" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                            <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                        </a>
                    </div>
                </div>
                <div class="col-span-2 sm:col-span-1 md:col-span-1 bg-sky-50 h-auto md:h-full flex flex-col">
                    <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 flex-grow">
                        <img src="https://5.imimg.com/data5/TestImages/YC/VC/JQ/SELLER-55189093/office-cleaning-services-500x500.png" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                        <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                    </a>
                </div>
            </div>
