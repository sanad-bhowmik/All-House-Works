...
<head>
    ...
    <title>AllHouseWorks | Aircon Gas Top Up</title>
...
<body class="bg-white relative">
    ...
    <section class="parallax" style="position: relative; background: url('https://skybreeze.sg/wp-content/uploads/2020/03/skybreeze-gas-refilled-cropped-768x387.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">Aircon Gas Top Up</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Aircon Gas Top Up</p>
        </div>
    </section>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">Aircon Gas Top Up EXPERTS</h6>
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP Aircon Gas Top Up SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our comprehensive Aircon Gas Top Up service is designed to be hassle-free for you. From installation to repairs and maintenance, we ensure that your cooling systems are running smoothly and efficiently.
                                    </p>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF Aircon Gas Top Up SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our HVAC technicians offer a full range of Aircon Gas Top Up services, including system installations, repairs, maintenance, and troubleshooting to ensure your cooling system operates efficiently.
                                    </p>
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Aircon Gas Top Up for Modern Living Convenience</span>
            </h3>
            <style>
    ...
    <div>
        <div class="bg-gray-100 lg:py-12 lg:flex lg:justify-center">
            <div class="bg-white lg:mx-8 lg:flex lg:max-w-5xl lg:shadow-lg lg:rounded-lg">
                <div class="lg:w-1/2">
                    <div class="h-64 bg-cover lg:rounded-lg lg:h-full" style="background-image:url('https://www.coolearth.com.sg/wp-content/uploads/2018/07/aircon-gas-top-up.jpeg')"></div>
                </div>
                <div class="py-12 px-6 max-w-xl lg:max-w-5xl lg:w-1/2">
                    <h2 class="text-3xl text-gray-800 font-bold">Experiencing These <span class="text-indigo-600">Aircon Issues?</span></h2>
                    <p class="mt-4 text-gray-600">Regular aircon gas top-ups are necessary in order to ensure that your aircon has adequate levels of gas. Often there are signs displayed by your aircon to signal that a gas top-up may be necessary, so you don’t have to pre-empt it ahead of time.

                        The following are some of the factors that will tell you if you may need an aircon gas top up or an aircon chemical overhaul.</p>
                </div>
            </div>
        </div>
    </div>
