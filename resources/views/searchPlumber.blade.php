...
<!-- Header -->
    ...
    <section class="parallax" style="position: relative; background: url('https://media.graphassets.com/lwhfuGgtSSC29hhbu78x') no-repeat center center fixed; background-size: cover; height: 18.75rem;">
            ...
            <div id="cardContainer" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="card max-w-sm bg-white shadow-lg rounded-lg overflow-hidden" style="border-bottom:3px solid #f7a80c;">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <a href="/tapLeak"><button class="bg-yellow-500 text-black px-2 py-2 rounded hover:bg-yellow-200 ">Read More > </button></a>
                    </div>
                ...
                <div class="card max-w-sm bg-white shadow-lg rounded-lg overflow-hidden" style="border-bottom:3px solid #f7a80c;">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <a href="/showerInstall"> <button class="bg-yellow-500 text-black px-2 py-2 rounded hover:bg-yellow-200 ">Read More > </button></a>
                    </div>
                    <div class="flex ml-20 mb-6">
                        <div class="text-gray-600 flex">
                ...
                <div class="card max-w-sm bg-white shadow-lg rounded-lg overflow-hidden" style="border-bottom:3px solid #f7a80c;">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <a href="/toiletRepair"><button class="bg-yellow-500 text-black px-2 py-2 rounded hover:bg-yellow-200 ">Read More > </button></a>
                    </div>
                    <div class="flex ml-20 mb-6">
                        <div class="text-gray-600 flex">
                ...
                <div class="card max-w-sm bg-white shadow-lg rounded-lg overflow-hidden" style="border-bottom:3px solid #f7a80c;">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <a href="/toiletBowl"><button class="bg-yellow-500 text-black px-2 py-2 rounded hover:bg-yellow-200 ">Read More > </button></a>
                    </div>
                    <div class="flex ml-20 mb-6">
                        <div class="text-gray-600 flex">
                ...
                <div class="card max-w-sm bg-white shadow-lg rounded-lg overflow-hidden" style="border-bottom:3px solid #f7a80c;">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <a href="/pipeInstall"> <button class="bg-yellow-500 text-black px-2 py-2 rounded hover:bg-yellow-200 ">Read More > </button></a>
                    </div>
                    <div class="flex ml-20 mb-6">
                        <div class="text-gray-600 flex">
                ...
                <div class="card max-w-sm bg-white shadow-lg rounded-lg overflow-hidden" style="border-bottom:3px solid #f7a80c;">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <a href="/heaterinstall"> <button class="bg-yellow-500 text-black px-2 py-2 rounded hover:bg-yellow-200 ">Read More > </button></a>
                    </div>
                    <div class="flex ml-20 mb-6">
                        <div class="text-gray-600 flex">
                            <img src="{{ url('img/calendar.png') }}" alt="" class="mr-2 "><span> June 12, 2021</span>
                ...
                <div class="card  max-w-sm bg-white shadow-lg rounded-lg overflow-hidden" style="border-bottom:3px solid #f7a80c;">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <a href="/showerRepair"> <button class="bg-yellow-500 text-black px-2 py-2 rounded hover:bg-yellow-200 ">Read More > </button></a>
                    </div>
                    <div class="flex ml-20 mb-6">
                        <div class="text-gray-600 flex">
                            <img src="{{ url('img/calendar.png') }}" alt="" class="mr-2 "><span> June 12, 2021</span>
                ...
                <div class="card  max-w-sm bg-white shadow-lg rounded-lg overflow-hidden" style="border-bottom:3px solid #f7a80c;">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <a href="/plumbing"><button class="bg-yellow-500 text-black px-2 py-2 rounded hover:bg-yellow-200 ">Read More > </button></a>
                    </div>
                    <div class="flex ml-20 mb-6">
                        <div class="text-gray-600 flex">
                            <img src="{{ url('img/calendar.png') }}" alt="" class="mr-2 "><span> June 12, 2021</span>
            ...
            <div>
                ...
                <ul>
                    <li class=" flex justify-between py-1 border-b">
                        ...
                        <span class="text-gray-500 bg-gray-100 p-1 rounded-lg w-8 text-center">9</span>
                    </li>
                    <ul class="ml-4">
                        <a href="/bidetSpray">
                            <li class="flex justify-between py-1 border-b">
                                <span><span style="font-weight: 900;">-</span> Bidet Spray Installation</span>
                                <span class="text-gray-500 bg-gray-100 p-1 rounded-lg w-8 text-center">0</span>
                            </li>
                        </a>
