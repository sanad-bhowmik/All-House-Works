...
<head>
    ...
    <title>AllHouseWorks | Electric</title>
...
<body class="bg-white relative">
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Electric Services for Modern Living Convenience</span>
            </h3>
            <style>
    ...
    <section class="relative bg-white py-12" style="background: url('https://www.daylightelectrician.com/wp-content/uploads/2016/06/mans.jpg?id=2240') no-repeat right; background-size: auto; height: auto;background-attachment: fixed;">
        <div class="container mx-auto px-4 text-center relative z-10">
            <h2 class="text-3xl font-bold mb-4">ELECTRICIAN IN SINGAPORE</h2>
            <p class="mb-8 text-gray-700">
                Daylight Electrician Singapore provides all kinds of <a href="#" class="text-blue-500">electrical services</a> including <a href="#" class="text-blue-500">emergency electrician services</a>. Our EMA Licensed electrician and electrical workers are specially trained to execute all kinds of <a href="#" class="text-blue-500">electrical repairs and works</a> including <a href="#" class="text-blue-500">electrical installation</a> such as <a href="#" class="text-blue-500">light installation</a>, <a href="#" class="text-blue-500">ceiling fan installation</a>, <a href="#" class="text-blue-500">power point / power socket installation</a>, <a href="#" class="text-blue-500">power trip recovery</a> as well as <a href="#" class="text-blue-500">electrical wiring and rewiring</a>. Also with our use of modern technology, we are able to help you identify electrical problems and rectify it. Call us now as we are your trusted licensed electrician and electrical contractor in Singapore.
            </p>
            <div class="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-4">
                <div class="flex-1 bg-white p-6 rounded-lg shadow-lg">
                    <div class="flex items-center justify-center mb-4">
                        <img src="https://www.daylightelectrician.com/wp-content/uploads/2016/06/icon1.png" alt="Electrical Wiring">
                    </div>
                    <h3 class="text-xl font-semibold mb-2">Electrical Wiring</h3>
                    <p class="mb-4 text-gray-600">Our electrical wiring services include rewiring, electrical extension, power point installation.</p>
                </div>
                <div class="flex-1 bg-white p-6 rounded-lg shadow-lg">
                    <div class="flex items-center justify-center mb-4">
                        <img src="https://www.daylightelectrician.com/wp-content/uploads/2016/06/icon2.png" alt="Power Trip">
                    </div>
                    <h3 class="text-xl font-semibold mb-2">Power Trip</h3>
                    <p class="mb-4 text-gray-600">Experienced Power Trip or Power failure? No worries, our Licensed Electrician will troubleshoot & fix it in minutes.</p>
                </div>
                <div class="flex-1 bg-white p-6 rounded-lg shadow-lg">
                    <div class="flex items-center justify-center mb-4">
                        <img src="https://www.daylightelectrician.com/wp-content/uploads/2016/06/icon3.png" alt="Electrical Installation">
                    </div>
                    <h3 class="text-xl font-semibold mb-2">Electrical Installation</h3>
                    <p class="mb-4 text-gray-600">We handle all kinds of installations, like switches, light fixtures, ceiling fans, power sockets, and others.</p>
                </div>
            </div>
        </div>
    </section>
