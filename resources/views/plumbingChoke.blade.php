...
<head>
    ...
    <title>AllHouseWorks | Plumbing Choke</title>
...
<body class="bg-white relative">
    ...
    <section class="parallax" style="position: relative; background: url('https://thumbor.forbes.com/thumbor/fit-in/x/https://www.forbes.com/home-improvement/wp-content/uploads/2022/09/featured-image-install-plumbing.jpeg.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            ...
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Plumbing / Plumbing Choke's</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://jkhengineering.com/wp-content/uploads/2022/09/jkhengineering.com-PLUMBING-CHOKE-SERVICES.jpg" class="w-full align-middle rounded-t-lg">
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Plumbing Choke Services for Modern Living Convenience</span>
            </h3>
            <style>
            ...
            <div class="flex flex-wrap justify-center -mx-4">
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://i.ytimg.com/vi/w7egUbTl3KY/maxresdefault.jpg" alt="" class="ml-14 mb-10" style="border: 1px solid #f7a80c;padding: 10px;height: 190px;">
                        <span class="text-primary font-semibold text-lg block mb-4">
                            Step 1: Diagnose the Plumbing Issue
                        </span>
                        <hr>
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                Our team begins by inspecting the affected plumbing system to identify the cause and location of the choke. This helps us understand the severity and choose the best approach for resolution.
                            </p>
                        </div>
                        <div>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://media.istockphoto.com/id/900825240/video/zooming-into-drain-blockage-cleaning-work.jpg?s=640x640&k=20&c=DQyc8mC0P6HVnvFJnZ1lRthZ3FZZ-Fq1wydM821s-ms=" alt="" class="ml-14 mb-10" style="border: 1px solid #f7a80c;padding: 10px;height: 190px;">
                        <span class="text-primary font-semibold text-lg block mb-4">
                        ...
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                We use specialized tools and techniques to effectively remove the blockage from your pipes. This may involve manual clearing methods or advanced equipment depending on the type and location of the choke.
                            </p>
                        </div>
                        <div>
                            <span class="absolute right-0 top-7 z-[-1]">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://img.freepik.com/premium-photo/temporary-plumbing-drainage-pipe_111959-290.jpg" alt="" class="ml-14 mb-10" style="border: 1px solid #f7a80c;padding: 10px;height: 190px;">
                        <span class="text-primary font-semibold text-lg block mb-4">
                        ...
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                After clearing the blockage, we thoroughly test the plumbing system to ensure that the issue is resolved and there are no remaining problems. We also provide recommendations to prevent future chokes.
                            </p>
                        </div>
                        <div>
                            <span class="absolute right-0 top-7 z-[-1]">
