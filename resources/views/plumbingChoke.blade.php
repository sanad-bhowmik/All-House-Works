            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://hdbplumberservice.com.sg/wp-content/uploads/2022/03/7-Essential-Characteristics-That-All-Plumbers-Must-Have-_-Plumber-in-North-Las-Vegas-NV.jpg" class="w-full align-middle rounded-t-lg">
