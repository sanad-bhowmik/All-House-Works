...
<head>
    ...
    <title>AllHouseWorks | Tap & Faucet</title>
...
<!-- Header -->
    ...
    <section class="parallax " style="position: relative; background: url('https://www.shutterstock.com/image-photo/faucet-sink-water-tab-decoration-260nw-442155709.jpg') no-repeat center center fixed; background-size: cover; height: 18.75rem;">
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Tap Faucet Services for Modern Living Convenience</span>
            </h3>
            <style>
            ...
            <div class="flex flex-wrap justify-center -mx-4">
                    ...
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        ...
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                Our team starts by thoroughly examining the tap to identify any issues such as leaks, drips, or malfunctioning controls. We assess the overall condition to determine the appropriate service required.
                            </p>
                        </div>
                        <div>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        ...
                        <span class="text-primary font-semibold text-lg block mb-4">
                            Step 2: Perform Repairs or Replacement
                        </span>
                        <hr>
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                Based on the inspection, we proceed with the necessary repairs or replacement. This may involve fixing leaks, replacing worn-out parts, or installing a new tap if required.
                            </p>
                        </div>
                        <div>
                            <span class="absolute right-0 top-7 z-[-1]">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        ...
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                After completing the repairs or installation, we thoroughly test the tap to ensure it functions correctly. We check for proper water flow, control operation, and leak prevention to ensure everything is in optimal condition.
                            </p>
                        </div>
                        <div>
                            <span class="absolute right-0 top-7 z-[-1]">
