...
<head>
    ...
    <title>AllHouseWorks | Aircon Repair</title>
...
<body class="bg-white relative">
    ...
    <section class="parallax" style="position: relative; background: url('https://www.socool.sg/wp-content/uploads/2023/12/removing-chemical-from-aircon-with-jet-spray-1.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">Aircon Repair</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Aircon Repair</p>
        </div>
    </section>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">Aircon Repair EXPERTS</h6>
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP Aircon Repair SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our comprehensive Aircon Repair service is designed to be hassle-free for you. From installation to repairs and maintenance, we ensure that your cooling systems are running smoothly and efficiently.
                                    </p>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF Aircon Repair SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our HVAC technicians offer a full range of Aircon Repair services, including system installations, repairs, maintenance, and troubleshooting to ensure your cooling system operates efficiently.
                                    </p>
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Aircon Repair for Modern Living Convenience</span>
            </h3>
            <style>
    ...
    <section class="max-w-7xl mx-auto px-4 py-8 lg:py-12">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="flex justify-center">
                <img src="https://5.imimg.com/data5/SELLER/Default/2023/8/331294348/FU/EX/GX/42838800/air-conditioner-repairing-service-500x500.jpg" alt="Aircon Repair" class="w-full h-auto object-cover">
            </div>

            <!-- Text Section -->
            <div>
                <h2 class="text-2xl lg:text-3xl font-semibold mb-4">Signs Your Aircon Needs Repair</h2>
                <p class="mb-4">
                    Your aircons may display these <a href="#" class="text-orange-500 underline">aircon repair symptoms</a>, which means that normal aircon servicing will no longer suffice. <a href="#" class="text-orange-500 underline">Call an aircon servicing company</a> to help you diagnose the problem.
                </p>

                <h3 class="text-xl lg:text-2xl font-semibold mb-4">Preventing Aircon Repairs</h3>
                <p class="mb-4">
                    If you can <a href="#" class="text-orange-500 underline">maintain your aircon regularly</a> then you will find that it performs well consistently, over time, and you will not see any major aircon repairs needed. Professional aircon companies and manufacturers suggest that you must take proper care of your aircon, so that it only requires minimal repairs during its lifetime.
                </p>

                <h3 class="text-xl lg:text-2xl font-semibold mb-4">When Aircon Repair Is Not Viable</h3>
                <p class="mb-4">
                    Sometimes an aircon repair requires a manufacturer part that is no longer in production, or that the model itself is phased out. Then the last resort is to replace your aircon by getting a <a href="#" class="text-orange-500 underline">new one installed</a>.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="max-w-7xl mx-auto px-4 py-8 lg:py-12">
        <!-- Title -->
        <h2 class="text-3xl lg:text-4xl font-bold text-center mb-8">AIRCON REPAIR SYMPTOMS</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="border-b-2 border-black pb-4">
                <h3 class="text-xl font-semibold mb-2">Odorous Smell</h3>
                <ul class="list-disc ml-4 text-sm">
                    <li>There are many reasons behind a smelly air conditioning unit. In order to ensure that such causes are prevented, regular aircon servicing is advised to inspect any leakages or remove any accumulated dust in the unit.</li>
                    <li>If the aircon has not undergone aircon servicing for a long time, and the smell issue arises, it is advised for it to go through an aircon chemical overhaul. The smell is usually caused by mould.</li>
                </ul>
            </div>

            <!-- Aircon Not Cold -->
            <div class="border-b-2 border-yellow-500 pb-4">
                <h3 class="text-xl font-semibold mb-2">Aircon Not Cold</h3>
                <ul class="list-disc ml-4 text-sm">
                    <li>Poor cooling performance also signals that it is time to contact <a href="#" class="text-orange-500 underline">Everyworks aircon servicing</a> to ensure that it is functioning properly and for any aircon repairs to be done.</li>
                    <li>There are many reasons why an aircon is not cold and an aircon technician can help to troubleshoot and diagnose the root cause of it.</li>
                </ul>
            </div>

            <!-- Aircon Leaking Water -->
            <div class="border-b-2 border-yellow-500 pb-4">
                <h3 class="text-xl font-semibold mb-2">Aircon Leaking Water</h3>
                <ul class="list-disc ml-4 text-sm">
                    <li>Noticed that your aircon is leaking water either from the front or from the back?</li>
                    <li>Aircon leaking could be due to frozen evaporator coils that melt, blocked aircon pipe or a full drainage tray. Aircon leaks can also be a sign of more underlying aircon issues.</li>
                    <li>Call an aircon technician to come check out what is causing your aircon leak.</li>
                </ul>
            </div>

            <!-- Aircon Lights Blinking -->
            <div class="border-b-2 border-black pb-4">
                <h3 class="text-xl font-semibold mb-2">Aircon Lights Blinking</h3>
                <ul class="list-disc ml-4 text-sm">
                    <li>When your aircon doesn’t seem to be functioning per normal, and it is accompanied with blinking indicator lights, then it is a sure sign an aircon repair is needed.</li>
                    <li>If you are unsure what the blinking light is code for, <a href="#" class="text-orange-500 underline">call our aircon experts</a> to help you troubleshoot and solve the problem for you.</li>
                </ul>
            </div>

            <!-- Noisy Air Conditioner -->
            <div class="border-b-2 border-black pb-4">
                <h3 class="text-xl font-semibold mb-2">Noisy Air Conditioner</h3>
                <ul class="list-disc ml-4 text-sm">
                    <li>Noise coming from an air conditioning unit might be a sign of a variety of aircon problems.</li>
                    <li>An <a href="#" class="text-orange-500 underline">Aircon Chemical Overhaul</a> may be the first best thing to do before pinpointing a specific cause of the aircon noise, so that aircon repairs can proceed.</li>
                </ul>
            </div>

            <!-- Aircon Switches Off Automatically -->
            <div class="border-b-2 border-yellow-500 pb-4">
                <h3 class="text-xl font-semibold mb-2">Aircon Switches Off Automatically</h3>
                <ul class="list-disc ml-4 text-sm">
                    <li>Does your aircon switch off on its own for no reason? This could be a sign of an aircon technical issue, and a clear indication an aircon repair is due.</li>
                    <li><a href="#" class="text-orange-500 underline">Everyworks</a> helps source manufacturer parts to help repair your aircon, as well as, provide the expert aircon repair works needed with professionalism and expertise.</li>
                </ul>
            </div>
