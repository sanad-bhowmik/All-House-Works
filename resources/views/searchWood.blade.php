...
<body class="bg-white relative">
    ...
    <section class="parallax" style="position: relative; background: url('https://cdn.britannica.com/87/143587-050-A1BE6799/wood.jpg') no-repeat center center fixed; background-size: cover; height: 18.75rem;">
                ...
                <ul>
                    <a href="/wood">
                     ...
                     <ul class="ml-4">
                        <a href="/parquetVarnish">
                            <li class="flex justify-between py-1 border-b">
                                <span><span style="font-weight: 900;">-</span> Parquet Varnish</span>
                                <span class="text-gray-500 bg-gray-100 p-1 rounded-lg w-8 text-center">2</span>
                            </li>
                        </a>
                        <a href="/wood">
                            <li class="flex justify-between py-1 border-b">
                                <span><span style="font-weight: 900;">-</span> Wood Varnish</span>
                                <span class="text-gray-500 bg-gray-100 p-1 rounded-lg w-8 text-center">2</span>
                            </li>
                        </a>
                      </ul>
