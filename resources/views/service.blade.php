...
<head>
    ...
    <title>AllHouseWorks | Service</title>
...
<body class="bg-white relative">
    ...
    <section class="parallax" style="position: relative; background: url('https://t4.ftcdn.net/jpg/07/47/08/57/360_F_747085703_nJmmbdoLGNcQVoJvnCC6SVsNBXbXhV24.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-5xl gap-4">
                ...
                <div class="grid relative">
                    <a class="group hover:shadow-2xl duration-200 delay-75 w-full bg-white rounded-sm py-6 pr-6 pl-9" href="">
                        <img src="https://www.checkatrade.com/blog/wp-content/uploads/2021/01/Home-and-car-aircon-service-cost.jpg" alt="">
                ...
                <div class="grid relative">
                    <a class="group hover:shadow-2xl duration-200 delay-75 w-full bg-white rounded-sm py-6 pr-6 pl-9" href="">
                        <img src="https://lirp.cdn-website.com/0f137ce1/dms3rep/multi/opt/Order3594_Image2-640w.jpg" alt="">
                ...
                <div class="grid relative">
                    <a class="group hover:shadow-2xl duration-200 delay-75 w-full bg-white rounded-sm py-6 pr-6 pl-9" href="">
                        <img src="https://smithandbyford.weebly.com/uploads/4/6/3/5/46351161/4505057_orig.jpg" alt="">
    ...
    <section class="w-full h-56 lg:h-60 rounded-xl justify-center items-center focus:outline-none mb-10"style="background-image: linear-gradient(rgb(0,0,0,0.7), rgb(0,0,0,0.7)),
        url(https://img.pikbest.com/origin/09/17/44/54fpIkbEsTrpq.jpg!w700wp);background-attachment: fixed;">
        <div style="padding: 2rem; text-align: center;">
            <h1 style="font-size: 2rem; font-family: math; font-weight: 700;color: white;">Prefer To Chat With Customer Service?</h1>
