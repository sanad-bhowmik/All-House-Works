...
<head>
    ...
    <title>AllHouseWorks | Sofa Stain Remove</title>
...
<body class="bg-white relative">
    ...
    <section class="parallax " style="position: relative; background: url('https://www.thespruce.com/thmb/LwdGa6WMqT5JSA9Eh-iXWo4JaAU=/5000x0/filters:no_upscale():max_bytes(150000):strip_icc()/how-to-clean-fabric-sofa-without-water-5214386-hero-3d09505bf37f43dea198cee5de12acc9.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">SOFA STAIN REMOVE</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Deep Clean / SOFA STAIN REMOVE</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://www.prosofaclean.com.au/wp-content/uploads/2021/12/Sofa-Stain-Removal.jpg" class="w-full align-middle rounded-t-lg">
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Sofa Stain Services for Modern Living Convenience</span>
            </h3>
            <style>
