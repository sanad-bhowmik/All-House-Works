...
<style>
    ...
    .parallax {
        background-image: url("https://cdn.dribbble.com/users/2446970/screenshots/5883361/birdeye_001a.gif");
...
<!-- Header -->
    ...
    <section class="parallax">
        ...
        <div class="content flex pl-56" style="gap: 63%;margin-bottom: 100px;">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="/contact" class="ms-1 text-sm font-medium text-white hover:text-white md:ms-2 dark:text-gray-400 dark:hover:text-white">Contact</a>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-white md:ms-2 dark:text-gray-400">Review</span>
                        </div>
                    </li>
                </ol>
            </nav>
