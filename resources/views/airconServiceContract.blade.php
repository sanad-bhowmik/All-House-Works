...
<head>
    ...
    <title>AllHouseWorks | Aircon Service Contract</title>
...
<body class="bg-white relative">
    ...
    <section class="parallax" style="position: relative; background: url('https://www.billyaircon.com.sg/wp-content/uploads/2024/05/Sample-Quotation-and-Contract-Template-2625997937-1.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">Aircon Service Contract</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Aircon Service Contract</p>
        </div>
    </section>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0 lg:space-x-8">
            ...
            <div class="w-full lg:w-1/2 flex flex-col items-center lg:items-start space-y-4">
                <img src="https://www.billyaircon.com.sg/wp-content/uploads/2024/05/Sample-Quotation-and-Contract-Template-2625997367-1.jpg" alt="Aircon Servicing" class="w-full h-auto object-cover">

                <button class="bg-yellow-500 text-white font-bold py-3 px-6 rounded-lg hover:bg-yellow-600">
                    Contact Us Now!
                </button>

                <div class="flex items-center space-x-2">
                    <img src={{ url('img/icon2.png') }} alt="Logo" class="w-8 h-8">
                    <div class="text-gray-800 font-bold">
                        <span>All House Works </span>
                        <div class="text-green-600">4.9 <span class="text-sm text-gray-500">(Based on 8151 reviews)</span></div>
                    </div>
                </div>
            </div>

            <!-- Right Section (Why Choose Us and Request Assistance) -->
            <div class="w-full lg:w-1/2 flex flex-col space-y-8">
                <!-- Why Choose Us Section -->
                <div class="space-y-4">
                    <h2 class="text-2xl font-bold text-black">Why Choose Us?</h2>
                    <div class="border-b-2 border-yellow-500 w-16"></div>
                    <ul class="space-y-2 text-gray-700">
                        <li><strong>AIRCON EXPERTS:</strong> Our aircon technicians have over 10 years of experience in the industry, serving 1000s of residential & commercial estates.</li>
                        <li><strong>FULL 1-STOP AIRCON SERVICES:</strong> Our top-to-bottom aircon service is designed to be fuss-free for you. Besides having your aircon serviced, you can even buy & install aircon products from us at direct contractor prices!</li>
                        <li><strong>RANGE OF AIRCON SERVICES:</strong> Our aircon servicing technicians carry out a comprehensive list of air conditioning works including aircon installations, chemical overhaul, gas top-up & more. Each service is done with thorough care.</li>
                    </ul>
                </div>

                <!-- Request for Service Assistance Section -->
                <div class="space-y-4">
                    <h2 class="text-2xl font-bold text-black">Request For Service Assistance Now!</h2>
                    <div class="border-b-2 border-yellow-500 w-16"></div>
                    <ul class="space-y-2 text-gray-700">
                        <li class="flex items-center space-x-2">
                            <span class="text-green-500"><i class="fab fa-whatsapp"></i></span>
                            <span>Message us on WhatsApp</span>
                        </li>
                        <li class="flex items-center space-x-2">
                            <span class="text-orange-500"><i class="fas fa-comments"></i></span>
                            <span>Chat with our Customer Support</span>
                        </li>
                        <li class="flex items-center space-x-2">
                            <span class="text-blue-500"><i class="fas fa-tools"></i></span>
                            <span>Get Job Done!</span>
                        </li>
                    </ul>
                    <button class="bg-green-500 text-white font-bold py-3 px-6 rounded-lg hover:bg-green-600">
                        WhatsApp to Start Now!
                    </button>
                </div>
            </div>
        </div>
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Aircon Service Contract for Modern Living Convenience</span>
            </h3>
            <style>
    ...
    <div class="container mx-auto px-4 py-8">
        <!-- Heading -->
        <h2 class="text-2xl lg:text-3xl font-bold text-center mb-6">
        ...
        <div class="flex flex-col lg:flex-row items-center lg:space-x-8 space-y-6 lg:space-y-0">
            ...
            <div class="w-full lg:w-1/2">
                <img src="https://www.billyaircon.com.sg/wp-content/uploads/2024/05/Sample-Quotation-and-Contract-Template-2625997702-1.jpg" alt="Aircon Image" class="w-full h-auto object-cover">
            </div>

            <!-- Text Section -->
            <div class="w-full lg:w-1/2 text-gray-700 space-y-4">
                <p>
                ...
                <p>
                    Most homes and offices rely on air conditioners to provide a more conducive environment. However, aircon owners often overlook the fact that their AC units still need regular aircon servicing in order to function efficiently, despite several myths you've heard about it.
                </p>
                <p>
                    You might be tempted to conduct your own aircon maintenance, but it is better to work with a reputable and trusted aircon servicing company like <span class="font-bold text-yellow-500">Everyworks</span> Singapore Aircon Servicing to ensure proper and quality service. Sometimes your air conditioner is already faulty and servicing it will not help, in such cases you should request for Aircon Repair Services.
                </p>
                <p class="font-bold text-gray-800">
                    Please <span class="text-green-600">WhatsApp us at +65 8241 0032</span> to find out more about our Special Quarterly Aircon Servicing Contract Promotion.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4 py-8">
        <!-- Top Section: Common Aircon Problems -->
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8 text-center">
            <div class="border-2 border-gray-300 rounded-lg p-4 shadow-md">
                <h3 class="text-xl font-bold mb-2">Odorous Smell</h3>
                <p class="text-gray-700">
                    A persistent smell coming from your aircon unit could indicate a buildup of mold, bacteria, or other contaminants inside the unit.
                </p>
            </div>
            <div class="border-2 border-gray-300 rounded-lg p-4 shadow-md">
                <h3 class="text-xl font-bold mb-2">Warm Air or Noisy Air Conditioner</h3>
                <p class="text-gray-700">
                    If your aircon is blowing warm air or making loud noises, it might need a thorough cleaning or repairs to its internal components.
                </p>
            </div>
            <div class="border-2 border-gray-300 rounded-lg p-4 shadow-md">
                <h3 class="text-xl font-bold mb-2">Aircon Leaking Water</h3>
                <p class="text-gray-700">
                    An aircon that is leaking water could indicate clogged drains or a problem with the unit's pipes and connectors, needing professional attention.
                </p>
            </div>
        </div>
        ...
        <div class="flex justify-center mb-8">
            <button class="bg-green-600 text-white px-6 py-3 rounded-lg text-lg font-semibold shadow-md">
                WhatsApp to Start Now!
            </button>
        </div>

        <!-- Bottom Section: Aircon Services -->
        <h2 class="text-2xl lg:text-3xl font-bold text-center mb-6">OUR AIRCON SERVICING INCLUDES:</h2>
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 text-center">
            <div class="border-2 border-gray-300 rounded-lg p-4 shadow-md">
                <h3 class="text-xl font-bold mb-2">Aircon Filter Cleaning & Sanitizing</h3>
                <p class="text-gray-700">
                    Regular cleaning and sanitizing of aircon filters ensures optimal air quality and energy efficiency, reducing the risk of contaminants circulating.
                </p>
            </div>
            <div class="border-2 border-gray-300 rounded-lg p-4 shadow-md">
                <h3 class="text-xl font-bold mb-2">Evaporator & Condenser Coil Cleaning</h3>
                <p class="text-gray-700">
                    Ensures that your aircon unit's coils are free of dirt and debris, allowing for maximum cooling efficiency and performance.
                </p>
            </div>
            <div class="border-2 border-gray-300 rounded-lg p-4 shadow-md">
                <h3 class="text-xl font-bold mb-2">Drainage Tray Treatment</h3>
                <p class="text-gray-700">
                    Ensures that your aircon’s drainage tray is treated to prevent clogs and build-ups, keeping water from leaking into your home.
                </p>
            </div>
            <div class="border-2 border-gray-300 rounded-lg p-4 shadow-md">
                <h3 class="text-xl font-bold mb-2">Front Panel Outer Casing</h3>
                <p class="text-gray-700">
                    We clean and inspect your aircon unit's outer casing, ensuring there are no cracks, dirt, or damage affecting the system’s overall performance.
                </p>
            </div>
            <div class="border-2 border-gray-300 rounded-lg p-4 shadow-md">
                <h3 class="text-xl font-bold mb-2">Blower Wheel Servicing</h3>
                <p class="text-gray-700">
                    Cleaning the blower wheel ensures your aircon’s fan is operating efficiently and quietly, improving airflow and cooling capacity.
                </p>
            </div>
            <div class="border-2 border-gray-300 rounded-lg p-4 shadow-md">
                <h3 class="text-xl font-bold mb-2">Vacuuming of Aircon Pipe</h3>
                <p class="text-gray-700">
                    Ensures that your aircon’s pipes are clean and free from blockages that could reduce the cooling efficiency of the system.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mx-auto mb-10 max-w-[370px]">
                        <div class="mb-8 overflow-hidden rounded">
                            <img
                                src="https://thumbs.dreamstime.com/b/air-conditioning-repair-repairman-fixing-system-male-technician-service-maintenance-conditioners-214302500.jpg"
                                alt="image"
                                class="w-full" />
                        </div>
                    </div>
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mx-auto mb-10 max-w-[370px]">
                        <div class="mb-8 overflow-hidden rounded">
                            <img
                                src="https://t4.ftcdn.net/jpg/03/28/12/65/360_F_328126538_lFF5jkeKQgohC6ZXW6depqiFiwvR5Xrh.jpg"
                                alt="image"
                                class="w-full" />
                        </div>
                    </div>
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mx-auto mb-10 max-w-[370px]">
                        <div class="mb-8 overflow-hidden rounded">
                            <img
                                src="https://www.shutterstock.com/image-photo/air-conditioning-cleaning-service-water-600nw-2239298447.jpg"
                                alt="image"
                                class="w-full" />
                        </div>
                    </div>
    ...
    <section class="max-w-7xl mx-auto px-4 py-8 lg:py-12">
        <!-- Title -->
        <h2 class="text-3xl lg:text-4xl font-bold text-center mb-8">Possible Aircon Causes</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white border-l-4 border-blue-500 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg p-6">
                <h3 class="text-xl font-semibold mb-2 text-gray-900">Aircon Leaking Water
                </h3>
                <p class="text-gray-700 text-sm">
                    When there is a gas shortage, there is not enough coolant to convert the warm air into cool, resulting in the condensate to pool and leak. The aircon water leakage may occur due to other reasons but gas shortage could also be one of the reasons.
                </p>
            </div>
            ...
            <div class="bg-white border-l-4 border-yellow-500 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg p-6">
                <h3 class="text-xl font-semibold mb-2 text-gray-900">Persistent Aircon Issues</h3>
                <p class="text-gray-700 text-sm">
                    Your aircon unit may not be working for a number of reasons, since there are so many working parts. As such, when you have recently performed an aircon repair but the issues still persist, you may want to call a professional aircon service company to check the aircon gas pressure to see if its low.
                </p>
            </div>
            ...
            <div class="bg-white border-l-4 border-red-500 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg p-6">
                <h3 class="text-xl font-semibold mb-2 text-gray-900">Aircon Exertion</h3>
                <p class="text-gray-700 text-sm">
                    There is a definite moment when your aircon stops blowing at full speed because the room is cooled to the set temperature. However, if your aircon seems to be noticeably running at high power for an extended length of time, similar to when the toilet tank seems to be refilling endlessly, you might want to get the aircon checked for gas.
                </p>
            </div>
        </div>
