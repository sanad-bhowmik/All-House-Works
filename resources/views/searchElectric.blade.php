...
<!-- Header -->
    ...
    <!-- Navigation Menu -->
    <section class="parallax" style="position: relative; background: url('https://www.shutterstock.com/image-photo/electrician-engineer-checks-electrical-circuit-600nw-1780414628.jpg') no-repeat center center fixed; background-size: cover; height: 18.75rem;">
