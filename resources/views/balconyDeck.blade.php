...
<head>
    ...
    <title>AllHouseWorks | Balcony Decking</title>
...
<body class="bg-white relative">
    ...
    <!-- Navigation Menu -->
    <section class="parallax" style="position: relative; background: url('https://cdnassets.hw.net/a4/30/2b6b1efc4bdb9b7ce0e1186929fc/balcony-15-crop.JPG') no-repeat center center fixed; background-size: cover; height: 300px;">
