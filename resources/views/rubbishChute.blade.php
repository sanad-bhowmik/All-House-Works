...
<head>
    ...
    <title>AllHouseWorks | Rubbish Chute</title>
...
<body class="bg-white relative">
    ...
    <!-- Header -->
    <section class="parallax" style="position: relative; background: url('https://media.homeanddecor.com.sg/public/2017/07/68756-rubbishchute.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Rubbish Chute Services for Modern Living Convenience</span>
            </h3>
            <style>
 ...
 <!-- Price -->
    ...
    <section class="bg-white lg:pt-[120px] lg:ml-20 pb-12 lg:pb-[90px] relative z-20 overflow-hidden">
        <div class="container">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3 p-4 max-w-[400px] md:max-w-[600px] place-items-center">
                <img class="hover:opacity-75" src="https://www.handymanservicessingapore.com/wp-content/uploads/2021/05/68756-Rubbish-Chutehchute.jpg">
                <img class="hover:opacity-75" src="https://www.pwplumbing.com.sg/wp-content/uploads/2023/03/rubbish-chute-replacement.jpeg">
                <img class="hover:opacity-75" src="https://www.hdbuildsg.com/image/aliving/image/cache/data/all_product_images/product-169/rQdd6qUl1587991525-3648x2736.JPG">
            </div>
        </div>
    </section>
    <!-- ====== Pricing Section End -->
    ...
    <section class="container mx-auto p-4">
        <!-- Section Title -->
        <h2 class="text-center text-2xl font-bold text-blue-900 mb-8">Quality Rubbish Chutes & Professional Services</h2>

        <!-- Service Cards -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Quick Service Delivery -->
            <div class="flex items-center p-4 bg-green-500 rounded-lg">
                <div class="flex-shrink-0">
                    <img src="https://img.icons8.com/ios-filled/50/ffffff/delivery.png" alt="Delivery Icon" style="width: 40px; height: 40px;">
                </div>
                <div class="ml-4">
                    <h3 class="text-lg font-bold text-white">Quick Service Delivery</h3>
                    <p class="text-white mt-1">Our fast-response team ensures you do not have to wait long for your rubbish chute replacement.</p>
                </div>
            </div>
            ...
            <div class="flex items-center p-4 bg-green-500 rounded-lg">
                <div class="flex-shrink-0">
                    <img src="https://img.icons8.com/ios-filled/50/ffffff/maintenance.png" alt="Maintenance Icon" style="width: 40px; height: 40px;">
                </div>
                <div class="ml-4">
                    <h3 class="text-lg font-bold text-white">Professional Services</h3>
                    <p class="text-white mt-1">With professional tools and expertise, we efficiently remove, install, seal, and clean up your rubbish chute area in 3 hours tops.</p>
                </div>
            </div>
            ...
            <div class="flex items-center p-4 bg-green-500 rounded-lg">
                <div class="flex-shrink-0">
                    <img src="https://www.freeiconspng.com/thumbs/contact-icon-png/contacts-icon--26.png" alt="Client Icon" style="width: 40px; height: 40px;">
                </div>
                <div class="ml-4">
                    <h3 class="text-lg font-bold text-white">We Amaze Clients</h3>
                    <p class="text-white mt-1">Our affordable prices and excellent rubbish chute installation surprise clients with how well we carry out our jobs.</p>
                </div>
            </div>
        </div>
    </section>
