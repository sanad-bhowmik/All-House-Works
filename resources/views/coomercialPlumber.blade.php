...
<head>
    ...
    <title>AllHouseWorks | Commercial Plumber</title>
...
<!-- Header -->
    ...
    <section class="parallax" style="position: relative; background: url('https://media.licdn.com/dms/image/C5612AQE4triZC5LKNg/article-cover_image-shrink_600_2000/0/1624629611813?e=2147483647&v=beta&t=_kJH_HsRBOg6gHmwtczTbAN4g84QTwYbPn6GCkKWWcI') no-repeat center center fixed; background-size: cover; height: 18.75rem;">
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Commercial Plumber Services for Modern Living Convenience</span>
            </h3>
            <style>
                ...
                <div class="w-full px-4">
                    <div class="text-center mx-auto mb-[3.75rem] lg:mb-20 max-w-[31.875rem]">
                        <h2 class=" font-bold  text-3xl sm:text-4xl md:text-[2.5rem] text-dark mb-4 ">
                            OUR FLOOR COOMERCIAL PLUMBING PROCESS
                        </h2>
                    </div>
                </div>
            </div>
            <div class="flex flex-wrap justify-center -mx-4">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        ...
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                In this step, we employ the powerful BonaÂ® machine scrubber specifically designed for tackling even the most stubborn light stains.
                            </p>
                        </div>
                        <div>
                            <span class="absolute right-0 top-7 z-[-1]">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        ...
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                We use targeted chemical cleaning solutions along with the BonaÂ® power scrubber to deep clean and eliminate dirt and grime on any type of flooring.
                            </p>
                        </div>
                        <div>
                            <span class="absolute right-0 top-7 z-[-1]">
