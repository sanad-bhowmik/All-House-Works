...
<head>
    ...
    <title>AllHouseWorks | Bidet Spray</title>
...
<!-- Scroll Up -->
    ...
    <section class="parallax" style="position: relative; background: url('https://whywait.com.au/wp-content/uploads/2024/04/Can-you-install-a-bidet-spray.jpg') no-repeat center center fixed; background-size: cover; height: 18.75rem;">
    ...
    <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Bidet Spray Services for Modern Living Convenience</span>
            </h3>
            <style>
