...
<head>
    ...
    <title>AllHouseWorks | Aircon Install</title>
...
<body class="bg-white relative">
    ...
    <section class="parallax" style="position: relative; background: url('https://www.metropolitanairconditioning.com.au/wp-content/uploads/2020/11/air-conditioner-installations-img.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">AIRCON INSTALL</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Aircon Install</p>
        </div>
    </section>
    ...
    <div class="container mx-auto p-6">
        <!-- Aircon Installation Sections -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Installing Daikin Aircons -->
            <div class="bg-yellow-100 p-6 rounded-lg shadow-md border-l-4 border-yellow-500">
                <h3 class="text-2xl font-bold text-yellow-700 mb-4">Installing Daikin Aircons</h3>
                <ul class="list-disc pl-5 text-yellow-800">
                    <li>Daikin Aircon – System 1</li>
                    <li>Daikin Aircon – System 2</li>
                    <li>Daikin Aircon – System 3</li>
                    <li>Daikin Aircon – System 4</li>
                </ul>
            </div>

            <!-- Installing Mitsubishi Aircons -->
            <div class="bg-red-100 p-6 rounded-lg shadow-md border-l-4 border-red-500">
                <h3 class="text-2xl font-bold text-red-700 mb-4">Installing Mitsubishi Aircons</h3>
                <ul class="list-disc pl-5 text-red-800">
                    <li>Mitsubishi Aircon – System 1</li>
                    <li>Mitsubishi Aircon – System 2</li>
                    <li>Mitsubishi Aircon – System 3</li>
                    <li>Mitsubishi Aircon – System 4</li>
                </ul>
            </div>

            <!-- Installing Panasonic Aircons -->
            <div class="bg-blue-100 p-6 rounded-lg shadow-md border-l-4 border-blue-500">
                <h3 class="text-2xl font-bold text-blue-700 mb-4">Installing Panasonic Aircons</h3>
                <ul class="list-disc pl-5 text-blue-800">
                    <li>Panasonic Aircon – System 1</li>
                    <li>Panasonic Aircon – System 2</li>
                    <li>Panasonic Aircon – System 3</li>
                    <li>Panasonic Aircon – System 4</li>
                </ul>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            <!-- Installing Commercial Aircons -->
            <div class="bg-green-100 p-6 rounded-lg shadow-md border-l-4 border-green-500">
                <h3 class="text-2xl font-bold text-green-700 mb-4">Installing Commercial Aircons</h3>
                <ul class="list-disc pl-5 text-green-800">
                    <li>VRV Aircon Systems</li>
                    <li>VRF Aircon Systems</li>
                </ul>
            </div>

            <!-- Types of Aircon We Install -->
            <div class="bg-purple-100 p-6 rounded-lg shadow-md border-l-4 border-purple-500">
                <h3 class="text-2xl font-bold text-purple-700 mb-4">Types of Aircon We Install</h3>
                <ul class="list-disc pl-5 text-purple-800">
                    <li>Wall-Mounted Split System</li>
                    <li>Ceiling Aircon</li>
                    <li>Window Aircon</li>
                    <li>Centralised Aircon</li>
                    <li>Other Brands: Fujitsu, Midea, Samsung, LG, and more</li>
                </ul>
            </div>

            <!-- Aircon Installation Services -->
            <div class="bg-gray-100 p-6 rounded-lg shadow-md border-l-4 border-gray-500">
                <h3 class="text-2xl font-bold text-gray-700 mb-4">Aircon Installation Services</h3>
                <p class="text-justify text-gray-800">
                    Contact our expert consultants today to discuss your aircon installation needs. We provide tailored recommendations based on your space, cooling requirements, and budget. Our services ensure you get the right system, optimal BTU capacity, and proper placement for maximum efficiency.
                </p>
            </div>
        </div>
    </div>
                    ...
                    <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                        <div class="pr-12">
                            <h1 class="text-white font-semibold text-5xl">
                                Why Choose Allhouseworks?
                            </h1>
                            <p class="mt-4 text-lg text-blueGray-200">
                                At Allhouseworks, we are dedicated to providing top-notch aircon services tailored to your needs. Our team of skilled professionals ensures that your air conditioning system is installed, serviced, and repaired with precision and care. Choose us for our expertise, reliability, and commitment to customer satisfaction.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl font-semibold">Exceptional Quality</h6>
                                <p class="mt-2 mb-4 text-blueGray-500">
                                    Our aircon services are carried out with the highest quality standards. We use premium materials and the latest technology to ensure your system operates efficiently and reliably.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="w-full md:w-4/12 px-4 text-center">
                        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl font-semibold">Timely Service</h6>
                                <p class="mt-2 mb-4 text-blueGray-500">
                                    We value your time and strive to complete every job within the promised timeframe. Our team arrives on time and works efficiently to minimize any disruptions.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="pt-6 w-full md:w-4/12 px-4 text-center">
                        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl font-semibold">Customer Satisfaction</h6>
                                <p class="mt-2 mb-4 text-blueGray-500">
                                    Our commitment to customer satisfaction is our top priority. We listen to your needs, address your concerns, and ensure that you are completely satisfied with our services.
                                </p>
                            </div>
                        </div>
                    </div>
