...
<!-- Header -->
    ...
    <section class="parallax" style="position: relative; background: url('https://greencleancs.com/wp-content/uploads/2013/10/floor_care_head.jpg') no-repeat center center fixed; background-size: cover; height: 18.75rem;">
    ...
    <section class="py-12 flex flex-col md:flex-row">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div id="cardContainer" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <!-- Card 3 -->
                <div class="card max-w-sm bg-white shadow-lg rounded-lg overflow-hidden" style="border-bottom:3px solid #f7a80c;">
                    <img class="w-full h-48 object-cover" src="https://thevinylfactory.com/wp-content/uploads/2015/06/dusty-records.png" alt="Card Image">
                    <div class="p-6 text-center">
                    ...
                    <ul class="ml-4">
                        ...
                        <a href="/vinylClean">
                            <li class="flex justify-between py-1 border-b">
                                ...
                                <span class="text-gray-500 bg-gray-100 p-1 rounded-lg w-8 text-center">3</span>
                            </li>
                        </a>
                        <a href="/vinylDeepFloorClean">
                            <li class="flex justify-between py-1 border-b">
