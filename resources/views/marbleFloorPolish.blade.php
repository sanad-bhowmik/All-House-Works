...
<body class="bg-white relative">
    ...
    <section class="parallax" style="position: relative; background: url('https://media.istockphoto.com/id/1387242475/photo/cleaning-the-floor-with-machine.jpg?s=612x612&w=0&k=20&c=Q7welGyGu-d8ZGRKDTdIIk5HPy3olVGKwPjRXEbNV9o=') no-repeat center center fixed; background-size: cover; height: 300px;">
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://setinstonerestoration.com/wp-content/uploads/2018/09/marble-before-after.jpg" class="w-full align-middle rounded-t-lg">
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Marble Polish Services for Modern Living Convenience</span>
            </h3>
            <style>
