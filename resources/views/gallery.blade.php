...
<style>
    ...
    .parallax {
        background-image: url("https://burst.shopifycdn.com/photos/macbook-air-on-desk.jpg?width=1000&format=pjpg&exif=0&iptc=0");
...
<body class="bg-white relative">
                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start ">
                    <div class="hidden sm:block sm:ml-6">
                        <div class="flex space-x-16">
                            <div class="border-r-2 border-l-2 hover-border-top">
                            ...
                            <div class="hover-border-top border-r border-l" style="border-top: 4px solid #B48F57;">
    ...
    <section class="parallax mt-16">
        ...
        <div class="content flex pl-56" style="gap: 63%;">
            ...
            <p style="font-size: 20px;color: antiquewhite;">Home / Works</p>
        </div>
    </section>
