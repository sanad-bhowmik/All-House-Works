...
<head>
    ...
    <title>AllHouseWorks | Aircon Leak</title>
...
<body class="bg-white relative">
    ...
    <section class="parallax" style="position: relative; background: url('https://www.air-con.com.sg/wp-content/uploads/2022/08/Can-I-Fix-Aircon-Leaking-Issue-Myself.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">Aircon Leaking</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Aircon Leaking</p>
        </div>
    </section>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">Aircon Leaking EXPERTS</h6>
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP Aircon Leaking SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our comprehensive Aircon Leaking service is designed to be hassle-free for you. From installation to repairs and maintenance, we ensure that your cooling systems are running smoothly and efficiently.
                                    </p>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF Aircon Leaking SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our HVAC technicians offer a full range of Aircon Leaking services, including system installations, repairs, maintenance, and troubleshooting to ensure your cooling system operates efficiently.
                                    </p>
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Aircon Leaking for Modern Living Convenience</span>
            </h3>
            <style>
    ...
    <section class="max-w-7xl mx-auto px-4 py-8 lg:py-12">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="flex justify-center">
                <img src="https://d1fpslrlhpinmq.cloudfront.net/wp-content/uploads/sites/21/2023/01/AdobeStock_459598171-scaled.jpeg" alt="Aircon Leaking" class="w-full h-auto object-cover">
            </div>
            ...
            <div>
                ...
                <p class="mb-4">
                    Your aircons may display these <a href="#" class="text-orange-500 underline">Aircon Leaking symptoms</a>, which means that normal aircon servicing will no longer suffice. <a href="#" class="text-orange-500 underline">Call an aircon servicing company</a> to help you diagnose the problem.
                </p>

                <h3 class="text-xl lg:text-2xl font-semibold mb-4">Preventing Aircon Leakings</h3>
                <p class="mb-4">
                    If you can <a href="#" class="text-orange-500 underline">maintain your aircon regularly</a> then you will find that it performs well consistently, over time, and you will not see any major Aircon Leakings needed. Professional aircon companies and manufacturers suggest that you must take proper care of your aircon, so that it only requires minimal repairs during its lifetime.
                </p>

                <h3 class="text-xl lg:text-2xl font-semibold mb-4">When Aircon Leaking Is Not Viable</h3>
                <p class="mb-4">
                    Sometimes an Aircon Leaking requires a manufacturer part that is no longer in production, or that the model itself is phased out. Then the last resort is to replace your aircon by getting a <a href="#" class="text-orange-500 underline">new one installed</a>.
                </p>

                <h3 class="text-xl lg:text-2xl font-semibold mb-4">Aircon Water Leaks</h3>
                <p class="mb-4">
                    ...
                    <a href="#" class="text-orange-500 underline">Call an aircon technician</a> to come check out what is causing your aircon leak.
                </p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white border-l-4 border-blue-500 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg p-6">
                ...
                <p class="text-gray-700 text-sm">
                    When your air filter is clogged with dirt and dust for too long, the aircon’s evaporator coil condenses and forms an icy layer, which melts and causes your aircon to leak water.
                </p>
            </div>
            ...
            <div class="bg-white border-l-4 border-yellow-500 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg p-6">
                <h3 class="text-xl font-semibold mb-2 text-gray-900">Blocked Drainage Pipe</h3>
                <p class="text-gray-700 text-sm">
                    If there’s nowhere for condensation to exit the aircon through the pipe, this water will then flow back out through the front of the aircon.
                </p>
            </div>
            ...
            <div class="bg-white border-l-4 border-red-500 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg p-6">
                <h3 class="text-xl font-semibold mb-2 text-gray-900">Aircon Pump Spoilt</h3>
                <p class="text-gray-700 text-sm">
                    The condensation pump is located below the cooling coil. The pump may not be working due to accumulated dirt and debris, or is broken.
                </p>
            </div>
            ...
            <div class="bg-white border-l-4 border-green-500 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg p-6">
                <h3 class="text-xl font-semibold mb-2 text-gray-900">Drainage Tray Full</h3>
                <p class="text-gray-700 text-sm">
                    If the drainage tray is full, this will cause a backflow and shows up in the form of your aircon leaking water.
                </p>
            </div>
            ...
            <div class="bg-white border-l-4 border-indigo-500 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg p-6">
                <h3 class="text-xl font-semibold mb-2 text-gray-900">Faulty Aircon Installation</h3>
                <p class="text-gray-700 text-sm">
                    There are a few techniques to install an aircon unit to ensure proper drainage. When installed improperly, aircon leaks are one of the early signs of faulty installation.
                </p>
            </div>
            ...
            <div class="bg-white border-l-4 border-purple-500 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg p-6">
                <h3 class="text-xl font-semibold mb-2 text-gray-900">Leaking Condenser Coil</h3>
                <p class="text-gray-700 text-sm">
                    The condenser is the outdoor aircon unit, which is highly likely to encounter blockage due to the accumulated dirt and debris outdoors.
                </p>
            </div>
        </div>
