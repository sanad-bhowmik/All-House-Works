...
<head>
    ...
    <title>AllHouseWorks | Fabric Sofa Clean</title>
...
<!-- Header -->
    ...
    <section class="parallax" style="position: relative; background: url('https://www.fairprice.com.sg/wp-content/uploads/2021/05/How-to-clean-a-fabric-sofa-970x526.png') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">Fabric Sofa Clean</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Fabric Sofa Clean</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://images.woodenstreet.de/image/data/juhi/blog%20images/26-march-2022/sofa-cleaning-at-home-2.jpg" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4">
                            <h4 class="text-xl font-bold text-white">
                                Fabric Sofa Clean  SERVICES
                            </h4>
                            <p class="text-md font-light mt-2 text-white">
                                Fabric Sofa Clean services include leak repairs, fixture Repairations, and maintenance for efficient water systems in homes and businesses, ensuring reliable operation and minimizing disruptions.
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">Fabric Sofa Clean EXPERTS</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our Fabric Sofa Cleans have over 35 years of experience in the industry, serving 1000s of residential & commercial estates.
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP Fabric Sofa Clean SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our top-to-bottom Fabric Sofa Clean service is designed to be fuss-free for you. Besides having your Electrical fixtures repaired or replace.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF Fabric Sofa Clean SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our Fabric Sofa Cleans carry out a comprehensive list of Fabric Sofa Clean works including clearing chokes, fixing leaks, water heater services.
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
                ...
                <div class="w-full px-4">
                    <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
                        <h2 class=" font-bold  text-3xl sm:text-4xl md:text-[40px] text-dark mb-4 ">
                            OUR FULL RANGE OF Fabric Sofa Clean SERVICES INCLUDE:
                        </h2>
                    </div>
                </div>
            </div>
...
<div class="mb-7">
    ...
    <p class="text-base text-body-color leading-loose mb-1">
        Refresh and Revitalize Your Sofa
    </p>
                        </div>
                        <div>
    ...
    <section class="bg-white mt-4">
        <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4">
                <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
                    <h2 class=" font-bold  text-3xl sm:text-4xl md:text-[40px] text-dark mb-4 ">
                        OUR COMPLETED SOFA CLEAN WORKS
                    </h2>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 h-full">
                <div class="col-span-2 sm:col-span-1 md:col-span-2 bg-gray-50 h-auto md:h-full flex flex-col">
                    <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 flex-grow">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSu2eUblWEyINV4RgEnJvS0R-Art7U3WbxUsg&s" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                        <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                    </a>
                </div>
                <div class="col-span-2 sm:col-span-1 md:col-span-2 bg-stone-50">
                    <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 mb-4">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRk-SFnpurZDdaSMZk3kiYJ38Y1XwQleatopQ&s" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                        <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                    </a>
                    <div class="grid gap-4 grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
                        <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40">
                            <img src="https://prohousekeepers.com/wp-content/uploads/2021/07/Fabric-Sofa-Couch-Clean.jpg" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                            <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                        </a>
                        <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40">
                            <img src="https://www.thespruce.com/thmb/LwdGa6WMqT5JSA9Eh-iXWo4JaAU=/5000x0/filters:no_upscale():max_bytes(150000):strip_icc()/how-to-clean-fabric-sofa-without-water-5214386-hero-3d09505bf37f43dea198cee5de12acc9.jpg" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                            <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                        </a>
                    </div>
                </div>
                <div class="col-span-2 sm:col-span-1 md:col-span-1 bg-sky-50 h-auto md:h-full flex flex-col">
                    <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 flex-grow">
                        <img src="https://i0.wp.com/oakabode.com/wp-content/uploads/2020/08/Sequence-01.Still013-3-1.jpg?fit=1500%2C844&ssl=1" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                        <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                    </a>
                </div>
            </div>
    ...
    <div class="py-24 px-8 max-w-5xl mx-auto flex flex-col md:flex-row gap-12 mt-10">
        ...
        <ul class="basis-1/2">
            <li>
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden" style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed">Whether it comes to broken pipes, leaky faucets, or clogged drains, it is best to call up a professional Singapore Fabric Sofa Clean who has the license, skills, tools and expertise to deal with the task. Here are some things to consider before looking to engage a Fabric Sofa Clean.
                            License / Accreditations
                            A PUB license is important for big plumbing projects, especially for HDB or commerciarenovations that require hacking into the plumbing systems. However, most Fabric Sofa Cleans should bBCA-licensed for common domestic plumbing works like solving water leaks and water pipe works.
                            Experience
                            Looking for an experienced Fabric Sofa Clean is key if you do not want the plumbing issue they are fixinto come back again. A Fabric Sofa Clean who is confident in their skills is equivalent to how many yearthey have been working in the industry.
                            ...
                            Warranty
                            Look at Singapore Fabric Sofa Clean services that offers plumbing works with workmanship or servicwarranty, and check if the warranty is extended to the plumbing products as well.
                        </div>
                    </div>
                </div>
            </li>
            <li>
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden" style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed">Plumbing emergencies do happen, and calling a Fabric Sofa Clean will be necessary. But you can certainly save money on plumbing works by preventing them from disrepair in the first place. Just follow these easy steps:
                            ...
                            Compare prices
                            Plumbing is a competitive business, and many different companies offer different plumbing services at differing prices. Make sure you do your own research in order to compare prices and find the right Fabric Sofa Clean who can do the job well for you.</div>
                    </div>
                </div>
            </li>
            <li>
