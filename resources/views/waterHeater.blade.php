...
<body class="bg-white relative">
    ...
    <section class="parallax  " style="position: relative; background: url('https://cdn.rotorootercdn.com/images/images/services/hero-size-adjustment/plumbing-water-heaters-9-by-4.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Water Heater Services for Modern Living Convenience</span>
            </h3>
            <style>
    ...
    <section class="bg-white lg:pt-[120px] pb-12 lg:pb-[90px] relative z-20 overflow-hidden">
        <div class="container">
            ...
            <div class="flex flex-wrap justify-center -mx-4">
                    ...
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        ...
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                Our team starts by thoroughly examining the water heater to assess its condition and identify any issues. We check for signs of wear, leaks, or malfunction to ensure a comprehensive understanding of the service required.
                            </p>
                        </div>
                        <div>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://carrollplumbingva.com/wp-content/uploads/2017/08/water-heater-repair.jpg" alt="" class="ml-14 mb-10" style="border: 1px solid #f7a80c;padding: 10px;height: 190px;">
                        <span class="text-primary font-semibold text-lg block mb-4">
                            Step 2: Perform Necessary Repairs or Maintenance
                        </span>
                        <hr>
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                Based on the inspection, we proceed with the necessary repairs or maintenance. This may include fixing leaks, replacing worn-out parts, or flushing the system to remove sediment buildup.
                            </p>
                        </div>
                        <div>
                            <span class="absolute right-0 top-7 z-[-1]">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://cdn.prod.website-files.com/64340a6de186e16583f9ec72/643846aab61df77968e8bce7_water-heater-flush-in-albuquerque.webp" alt="" class="ml-14 mb-10" style="border: 1px solid #f7a80c;padding: 10px;height: 190px;">
                        <span class="text-primary font-semibold text-lg block mb-4">
                        ...
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                After completing the repairs or maintenance, we thoroughly test the water heater to ensure it operates efficiently and effectively. We verify that it heats water properly and provide any recommendations for optimal performance.
                            </p>
                        </div>
                        <div>
                            <span class="absolute right-0 top-7 z-[-1]">
