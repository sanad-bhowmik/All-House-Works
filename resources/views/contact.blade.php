...
<head>
    ...
    <title>AllHouseWorks | Contact</title>
...
<body class="bg-white relative">
    ...
    <section class="bg-gray-100 h-auto flex flex-wrap justify-center p-4">
        <h2 class="w-full text-center mt-8 mb-8 text-lg font-bold">AllhouseWorks Groups Network of Service Brands</h2>
