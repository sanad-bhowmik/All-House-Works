...
<head>
    ...
    <title>AllHouseWorks | Plumbing Leak</title>
...
<body class="bg-white relative">
    ...
    <section class="parallax" style="position: relative; background: url('https://lirp.cdn-website.com/003cb91e409f4881af1748987930dba9/dms3rep/multi/opt/image-1-960w.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
    ...
    <section class="mt-10">
        <div class="relative flex flex-col md:flex-row items-center md:items-start mt-8">
            ...
            <h3 id="handyman-services" class="bg-black text-white black-polygon h-auto md:h-20 flex items-center justify-center ml-0 md:ml-24 pl-4 pr-4 md:pr-24 text-center md:text-left w-11/12 md:max-w-2/3" style="font-size: 26px;font-weight: 600;font-family: Josefin sans-serif;margin-left: 4%;">
                <span class="inner-span">All-in-One Plumbing leak Services for Modern Living Convenience</span>
            </h3>
            <style>
            ...
            <div class="flex flex-wrap justify-center -mx-4">
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://www.acmeplumbing.com/wp-content/uploads/2022/11/7-easy-ways-to-find-hidden-water-leaks-in-your-home.jpg" alt="" class="ml-14 mb-10" style="border: 1px solid #f7a80c;padding: 10px;height: 190px;">
                        ...
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                Our team begins by thoroughly inspecting the plumbing system to identify the source of the leak. We use advanced tools and techniques to detect leaks even in hidden or hard-to-reach areas.
                            </p>
                        </div>
                        <div>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://piperepair.co.uk/wp-content/uploads/2021/01/2021-01-29-Leaking-Pipe-678x381.jpg" alt="" class="ml-14 mb-10" style="border: 1px solid #f7a80c;padding: 10px;height: 190px;">
                        <span class="text-primary font-semibold text-lg block mb-4">
                        ...
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                Once the leak is located, we proceed with the appropriate repair method. This may involve sealing the leak, replacing damaged pipes, or tightening fittings to ensure a permanent fix.
                            </p>
                        </div>
                        <div>
                            <span class="absolute right-0 top-7 z-[-1]">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://nwwaterservices.ie/wp-content/uploads/2021/08/pipe-leaking.jpg" alt="" class="ml-14 mb-10" style="border: 1px solid #f7a80c;padding: 10px;height: 190px;">
                        <span class="text-primary font-semibold text-lg block mb-4">
                        ...
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                After the repair is completed, we thoroughly test the plumbing system to confirm that the leak has been fully addressed and that there are no further issues. We also provide guidance on maintenance to prevent future leaks.
                            </p>
                        </div>
                        <div>
                            <span class="absolute right-0 top-7 z-[-1]">
